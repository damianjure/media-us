  ...
  return (
    <div className="p-4">
      <div className="flex items-center gap-2 mb-4">
        ...
        <button onClick={() => setShowForm(true)} className="p-3 bg-indigo-600 rounded-xl text-white hover:bg-indigo-700 min-w-[44px] min-h-[44px] flex items-center justify-center active:scale-95 transition-transform" aria-label="Agregar persona">
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 bg-black/40 flex items-end sm:items-center justify-center" onClick={() => setShowForm(false)}>
          <div className="bg-white dark:bg-slate-900 rounded-t-2xl sm:rounded-2xl w-full sm:max-w-md max-h-[80vh] overflow-y-auto overscroll-contain" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="text-base font-semibold px-4 pt-3 pb-2">Nueva Persona</h3>
