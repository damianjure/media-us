  ...
  return (
    <div className="flex flex-col h-dvh bg-slate-50 dark:bg-slate-950">
      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
        <h1 className="text-lg font-bold text-slate-900 dark:text-white">Media Us</h1>
          ...
          >
            ...
            >
              ...
              <nav className="flex flex-col gap-1">
                ...
                <button className="px-3 py-2 rounded-lg text-sm text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 text-left">
                  Configuración
                </button>
                <button className="px-3 py-2 rounded-lg text-sm text-red-500 hover:bg-red-50 dark:hover:bg-red-950 text-left">
                  Cerrar sesión
                </button>
              </nav>
            </motion.div>
      ...
      {/* Bottom tab bar */}
      <nav className="flex items-center justify-around py-2 px-1 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 safe-area-bottom">
