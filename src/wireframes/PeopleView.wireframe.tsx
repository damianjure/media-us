...
const people = [
  ...
  { name: "Pedro López", role: "Bajo", team: "Músicos" },
  { name: "Ana Martínez", role: "Batería", team: "Músicos" },
  { name: "Diego Sánchez", role: "Sonido", team: "Audio" },
  { name: "Lucía Fernández", role: "Proyección", team: "Multimedia" },
  { name: "Sofía Álvarez", role: "Anfitrión", team: "Anfitriones" },
  { name: "Martín Díaz", role: "Anfitrión", team: "Anfitriones" },
];
