  ...
  return (
    <div className="min-h-dvh bg-white dark:bg-slate-950 pb-20">
      ...
      <div className="p-4 flex gap-3">
        <div className="flex-1 bg-white dark:bg-slate-900 rounded-xl p-3 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800">
          <p className="text-[10px] text-slate-400 uppercase font-medium mb-1">Aceptados</p>
          <p className="text-lg font-bold text-emerald-600">8</p>
        </div>
        <div className="flex-1 bg-white dark:bg-slate-900 rounded-xl p-3 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800">
          <p className="text-[10px] text-slate-400 uppercase font-medium mb-1">Declinados</p>
          <p className="text-lg font-bold text-red-500">1</p>
        </div>
        <div className="flex-1 bg-white dark:bg-slate-900 rounded-xl p-3 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800">
          <p className="text-[10px] text-slate-400 uppercase font-medium mb-1">Pendientes</p>
          ...
          {items.map((item) => {
            ...
            return (
              <Reorder.Item key={item.id} value={item} className="list-none">
                <motion.div
                  layout
                  className="flex items-center gap-3 bg-white dark:bg-slate-900 rounded-xl p-3 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800 cursor-grab active:cursor-grabbing"
                >
                  ...
                  <span className="text-[10px] text-slate-400 uppercase bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">
                    {item.type}
                  </span>
                </motion.div>
              </Reorder.Item>
      ...
      <p className="text-xs text-slate-400 mt-6 text-center">
        Arrastrá los items para reordenar
      </p>
    </div>
  );
}